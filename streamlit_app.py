...
st.markdown(
    ...
    .provider-card.selected {
        ...
        box-shadow: 0 0 0 1px var(--accent), 0 8px 24px -12px rgba(201, 162, 39, 0.35);
    }
    .provider-card .badge {
...
st.markdown(
    ...
    "No accountability is held for financial decisions or outcomes made using this tool.</div>",
    unsafe_allow_html=True,
)
